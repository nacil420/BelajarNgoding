    ...
    <div id='main' className='w-full h-screen text-center'>
        <div className='max-w-[1230px] w-full h-full mx-auto p-2 flex justify-center items-center'>
            <div>
                ...
                <Link href='/Login'>
                <button className='text-white justify-center text-center items-center bg-orange-500 rounded p-4 px-8 cursor-pointer hover:scale-105 ease-in duration-300'>Login</button>
                </Link>
            </div>
        </div>
    </div>
...
export default LandingPagesGuest